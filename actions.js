...
var marker = L.marker([-23.6446169, -46.5283129], 18);
...
var geojsonLayer = new L.GeoJSON.AJAX("https://uploadfiles.io/fwf0i/map(1).geojson", {dataType:"jsonp"}, {onEachFeature:popUp});
